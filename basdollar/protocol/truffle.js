...
const infuraId = process.env.Infura_URL_Id
...
module.exports = {
  ...
  networks: {
    ...
    bsc: {
    provider: () => new PrivateKeyProvider(process.env.privateKey, 'BSCAPI'),
    network_id: 56,          // Binance Smart Chain's id
  ...
  api_keys: {
    etherscan: 'MYN6TGPT8MZN974NYXHAAFIRJ4IZ789NGB'
  }
}
