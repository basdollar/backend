...
const INITIAL_STAKE_MULTIPLE = new BN(10).pow(new BN(6)); // 100 BASD -> 100M BASDS
...
describe('Pool', function () {
  ...
  beforeEach(async function () {
    ...
    this.dollar = await MockToken.new("Binance Agile Set Dollar", "BASD", 18, {from: ownerAddress, gas: 8000000});
